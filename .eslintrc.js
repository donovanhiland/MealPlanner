module.exports = {
  ...
  // Explanations and Examples: https://github.com/airbnb/javascript
  // RUN THIS VIA TERMINAL ON NEW INSTALLATION TO MAKE SURE CORRECT VERSIONS ARE INSTALLED
  // (
  ...
  "rules": {
    ...
    // "no-undef": 0, // disallow use of undeclared variables unless mentioned in a /*global */ block // OFF BECAUSE OF RAILS-REACT
    // "no-undef-init": 0, // disallow use of undefined when initializing variables // OFF BECAUSE OF RAILS-REACT
    // "no-undefined": 0, // disallow use of undefined variable (off by default) // OFF BECAUSE OF RAILS-REACT
    "no-unused-vars": [2, {
      "args": "none"
    }],
    ...
    // "camelcase": 0, // require camel case names // REVISIT
    // "comma-spacing": [1, {
    //   "before": false,
    //   "after": true
    ...
    "max-len": [0, 100, 2], // specify the maximum length of a line in your program (off by default)
    ...
    // "react/jsx-no-undef": 0, // Disallow undeclared variables in JSX // OFF BECAUSE OF RAILS-REACT
    ...
    "react/prop-types": 0, // Prevent missing props validation in a React component definition // OFF BECAUSE OF RAILS-REACT
    // "react/react-in-jsx-scope": 0, // Prevent missing React when using JSX // UNCOMMENT WHEN WE SWITCH OFF OF RAILS/REACT
    ...
    // // JSX linting
    // //
    "jsx-a11y/no-static-element-interactions": 0, // Enforce non-interactive DOM elements have no interactive handlers
  }
}
